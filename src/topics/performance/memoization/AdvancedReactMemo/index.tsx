...
import WithMemo from "./WithNestedMemo";
import WithoutMemo from "./WithoutNetsedMemo";
...
export default function AdvancedMemo() {
  const [value, setValue] = useState<Languages>(Languages.JAVA);
  const [clickCount, setClickCount] = useState(0);
  
  return (
    <div>
      <h1>Advanced React.memo Demonstration</h1>
      ...
      <div style={{ 
        ...
        <WithoutMemo
          data={{
            language: value,
            meta: { timestamp: new Date().toLocaleDateString() },
          }}
        />
        <WithMemo
          data={{
